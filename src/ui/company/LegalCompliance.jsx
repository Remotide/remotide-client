            ...
            <div className="flex flex-col flex-grow w-full">
              <div className="space-y-2 mb-5">
                ...
                <p className="max-w-[700px] text-gray-500 md:text-2xl">
                  ...
                  about the way we use it. Below you'll find our detailed
                  policies that outline your rights and our responsibilities.
                </p>
              </div>
              <div className="space-y-6 mb-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500 text-2xl">
                    ...
                    personal information when you use our website or interact
                    with us.
                  </p>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500 text-2xl">
                    This disclaimer governs your use of our website; by using
                    our website, you accept this disclaimer in full.
                  </p>
                </div>
              </div>
